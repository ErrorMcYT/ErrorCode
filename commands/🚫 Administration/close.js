...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      ) return message.reply("<:DGH_X_:928632737802358805> This Channel is not a Ticket!")
      var cmdrole = []
      ...
      if ((message.member.roles.cache.array() && !message.member.roles.cache.some(r => cmdroles.includes(r.id))) && !cmdroles.includes(message.author.id) && (message.member.roles.cache.array() && !message.member.roles.cache.some(r => adminroles.includes(r.id))) && !Array(message.guild.owner.id, config.ownerid).includes(message.author.id) && !message.member.hasPermission("ADMINISTRATOR") && !message.member.roles.cache.some(r => ticket.adminroles.includes(r.id)))
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<:DGH_X_:928632737802358805> You are not allowed to close a Ticket`)
        ...
        var originalowner = message.author;
          ...
          try {
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle("<:DGH_X_:928632737802358805> ERROR | Missing Permissions to add Reactions")
              .setColor(es.wrongcolor)
          ...
          if (timeouterror)
            return message.reply(new Discord.MessageEmbed()
              .setTitle("<:DGH_X_:928632737802358805> ERROR | Your Time ran out")
              .setColor(es.wrongcolor)
          ...
          if(temptype == "close"){
            ...
            message.reply(new Discord.MessageEmbed()
              ...
              msg.channel.awaitMessages(m=>m.author.id === originalowner.id, {max: 1, time: 90000, errors: ["time"]}).then(async collected=>{
                ...
                if(!user || user == null || user.id == null || !user.id) message.reply("<:DGH_X_:928632737802358805> Could not find the USER")
                        ...
                        if(!element.allow.includes("VIEW_CHANNEL")){
                          ...
                          .catch(e=>{
                            return message.channel.send(new MessageEmbed()
                              .setColor(es.wrongcolor)
                              .setFooter(es.footertext, es.footericon)
                              .setTitle(`<:DGH_X_:928632737802358805> An error occurred`)
            ...
            message.reply(new Discord.MessageEmbed()
              ...
              msg.channel.awaitMessages(m=>m.author.id === originalowner.id, {max: 1, time: 90000, errors: ["time"]}).then(async collected=>{
                ...
                if(!user || user == null || user.id == null || !user.id) message.reply("<:DGH_X_:928632737802358805> Could not find the ROLE")
                var mapped = msg.channel.permissionOverwrites.map(p => {
                  if(p.type == "role"){
                    var obj = {id: "", allow: []};
                    obj.id = p.id;
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle("<:DGH_X_:928632737802358805> ERROR | PLEASE CONTACT `Tomato#6966`")
              .setColor(es.wrongcolor)
              .setFooter(es.footertext, es.footericon)
            );
          }
