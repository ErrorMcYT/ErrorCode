    ...
    try {
      ...
      if (!warnmember)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:DGH_X_:928632737802358805> Please add a Member you want to warn!`)
      ...
      if (moderationPosition <= memberPosition)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<:DGH_X_:928632737802358805> I cannot warn someone, who is above/equal you`)
        );
      ...
      try {
        ...
        message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<a:arrow2:922760817064153139> Warned ${warnmember.user.tag}`)
