...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(args[0]){
          if(Number(args[0]) > 5000 || Number(args[0]) < 100) return message.reply("**<:DGH_X_:928632737802358805> Maximum amount of Messages to be pruned are 5000 (minimum 100)**")
          if(isNaN(args[0])) return message.reply("**<:DGH_X_:928632737802358805> Maximum amount of Messages to be pruned are 5000 (minimum 100)**")
