  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        .setThumbnail(client.user.displayAvatarURL())
.setColor(es.color)
.setFooter("Vixeon | Made by: NeoNitY", client.user.displayAvatarURL())
...
.setFooter(`Panda_Bot | Made by: NeoNity\nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL())
          ...
          let embed1 = new Discord.MessageEmbed()
            ...
            .setFooter(`Vixeon | Made by: NeoNitY\nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL())
          ...
          const items = cuc
            embed6.setTitle(`<a:Save:922776326086225961> **Custom Commands [${cuc[0].includes("NO") ? 0 : items.length}]**`)
            embed6.setDescription(items.join(", "))
